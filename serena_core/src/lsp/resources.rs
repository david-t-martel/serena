...
impl ResourceManager {
    ...
    pub async fn ensure_tool(&self, tool_name: &str, url: &str, executable_name: &str) -> Result<PathBuf> {
        ...
        if !executable_path.exists() {
            ...
            anyhow::bail!("Executable {} not found after extraction in {:?}", executable_name, tool_dir);
        }
