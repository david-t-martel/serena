    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                "Class",
                "Model.java",
                marks=(pytest.mark.java, pytest.mark.requires_network),
            ),
            ...
            pytest.param(
                ...
                "Function",
                "helper.php",
                marks=(pytest.mark.php, pytest.mark.requires_network),
            ),
            ...
            pytest.param(
                ...
                "Class",
                "Program.cs",
                marks=(pytest.mark.csharp, pytest.mark.requires_network),
            ),
